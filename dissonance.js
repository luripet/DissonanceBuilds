...
(() => {
  ...
  function _clearFolder() {
    _clearFolder = _async_to_generator(function* (path, { prefix = "dissonance/" } = {}) {
  ...
  function _removeFile() {
    _removeFile = _async_to_generator(function* (path, { prefix = "dissonance/" } = {}) {
  ...
  function _fileExists() {
    _fileExists = _async_to_generator(function* (path, { prefix = "dissonance/" } = {}) {
  ...
  function _writeFile() {
    _writeFile = _async_to_generator(function* (path, data, { prefix = "dissonance/" } = {}) {
  ...
  function _readFile() {
    _readFile = _async_to_generator(function* (path, { prefix = "dissonance/" } = {}) {
      try {
  ...
  function _downloadFile() {
    _downloadFile = _async_to_generator(function* (url2, path, { prefix = "dissonance/" } = {}) {
  ...
  var init_patcher = __esm({
    "src/lib/api/patcher.ts"() {
      ...
      _patcherDelaySymbol = Symbol.for("dissonance.api.patcher.delay");
      after = create(_after);
  ...
  // src/core/dissonance/Emitter.ts
  var Events, Emitter;
  ...
  var init_filters = __esm({
    "src/metro/filters.ts"() {
      ...
      init_factories();
      init_modules2();
      byProps = createFilterDefinition((props, m2) => props.length === 0 ? m2[props[0]] : props.every((p) => m2[p]), (props) => `dissonance.metro.byProps(${props.join(",")})`);
      byName = createFilterDefinition(([name], m2) => m2.name === name, (name) => `dissonance.metro.byName(${name})`);
      byDisplayName = createFilterDefinition(([displayName], m2) => m2.displayName === displayName, (name) => `dissonance.metro.byDisplayName(${name})`);
      byTypeName = createFilterDefinition(([typeName], m2) => m2.type?.name === typeName, (name) => `dissonance.metro.byTypeName(${name})`);
      byStoreName = createFilterDefinition(([name], m2) => m2.getName?.length === 0 && m2.getName() === name, (name) => `dissonance.metro.byStoreName(${name})`);
      byFilePath = createFilterDefinition(
        ...
        ([path, exportDefault]) => `dissonance.metro.byFilePath(${path},${exportDefault})`
      );
      byMutableProp = createFilterDefinition(([prop], m2) => m2?.[prop] && !Object.getOwnPropertyDescriptor(m2, prop)?.get, (prop) => `dissonance.metro.byMutableProp(${prop})`);
    }
  });
  ...
  var init_lazy2 = __esm({
    "src/metro/lazy.ts"() {
      ...
      init_caches();
      init_modules2();
      _lazyContextSymbol = Symbol.for("dissonance.metro.lazyContext");
  ...
  // src/core/dissonance/storage.ts
  ...
  var init_storage = __esm({
    "src/core/dissonance/storage.ts"() {
      ...
      emitterSymbol = Symbol.for("dissonance.storage.emitter");
      syncAwaitSymbol = Symbol.for("dissonance.storage.accessor");
  ...
  var init_storage2 = __esm({
    "src/lib/api/storage/index.ts"() {
      ...
      init_fs();
      init_dist();
      storageInitErrorSymbol = Symbol.for("dissonance.storage.initError");
      storagePromiseSymbol = Symbol.for("dissonance.storage.promise");
      _loadedStorage = {};
  ...
  __export(constants_exports, {
    ...
    DISSONANCE_PROXY_PREFIX: () => DISSONANCE_PROXY_PREFIX,
    GITHUB: () => GITHUB,
  ...
  var DISCORD_SERVER, GITHUB, HTTP_REGEX, HTTP_REGEX_MULTI, DISSONANCE_PROXY_PREFIX, OFFICIAL_PLUGINS_REPO_URL, VD_PROXY_PREFIX, VD_DISCORD_SERVER_ID, VD_PLUGINS_CHANNEL_ID, VD_THEMES_CHANNEL_ID;
  var init_constants = __esm({
    "src/lib/utils/constants.ts"() {
      ...
      DISSONANCE_PROXY_PREFIX = "https://bn-plugins.github.io/vd-proxy";
  ...
  var init_logger = __esm({
    "src/lib/utils/logger.ts"() {
      ...
      logger = new LoggerClass("Dissonance");
    }
  });
  ...
  var init_components = __esm({
    "src/metro/common/components.ts"() {
      ...
      init_finders();
      init_wrappers();
      bySingularProp = createFilterDefinition(([prop], m2) => m2[prop] && Object.keys(m2).length === 1, (prop) => `dissonance.metro.common.components.bySingularProp(${prop})`);
  ...
  function updateDissonanceColor(colorManifest, { update = true }) {
  ...
  function initColors(manifest) {
    ...
    if (manifest)
      updateDissonanceColor(manifest, {
        update: false
      });
    return () => patches2.forEach((p) => p());
  }
  ...
  function _fetchTheme() {
    _fetchTheme = _async_to_generator(function* (url2, selected = false) {
      ...
      if (selected) {
        ...
        updateDissonanceColor(themes[url2].data, {
          update: true
        });
      }
    });
  ...
  function selectTheme(theme, write = true) {
    ...
    if (theme == null && write) {
      updateDissonanceColor(null, {
        update: true
      });
      return writeThemeToNative({});
    } else if (theme) {
      updateDissonanceColor(theme.data, {
        update: true
      });
  ...
  var init_themes = __esm({
    "src/lib/addons/themes/index.ts"() {
      ...
      init_preferences();
      init_updater();
      themes = wrapSync(createStorage(createMMKVBackend("DISSONANCE_THEMES")));
    }
  });

  // src/lib/api/native/loader.ts
  function isDissonanceLoader() {
  ...
  function polyfillDissonanceLoaderIdentity() {
    if (!isPyonLoader() || isDissonanceLoader())
      return null;
    var loader = {
  ...
  function getDissonanceLoaderIdentity() {
    if (globalThis.__dissonance_loader)
      return globalThis.__dissonance_loader;
  ...
  function getLoaderName() {
    if (isPyonLoader())
      ...
      return dissonanceLoaderIdentity.name;
    return "Unknown";
  }
  ...
  function getStoredTheme() {
    if (isPyonLoader()) {
      ...
      var themeProp = dissonanceLoaderIdentity.features.themes?.prop;
      if (!themeProp)
        return null;
  ...
  var pyonLoaderIdentity, dissonanceLoaderIdentity;
  ...
  var init_settings = __esm({
    "src/lib/api/settings.ts"() {
      ...
      init_storage();
      init_loader();
      settings = wrapSync(createStorage(createMMKVBackend("DISSONANCE_SETTINGS")));
  ...
  function _initMetroCache() {
    _initMetroCache = _async_to_generator(function* () {
      if (!(yield fileExists(DISSONANCE_METRO_CACHE_PATH)))
        return void buildInitCache();
      var rawCache = yield readFile(DISSONANCE_METRO_CACHE_PATH);
      try {
  ...
  var CACHE_VERSION, DISSONANCE_METRO_CACHE_PATH, _metroCache, getMetroCache, saveCache;
  var init_caches = __esm({
    "src/metro/internals/caches.ts"() {
      ...
      init_enums();
      CACHE_VERSION = 102;
      DISSONANCE_METRO_CACHE_PATH = "caches/metro_modules.json";
      _metroCache = null;
      getMetroCache = () => _metroCache;
      saveCache = debounce(() => {
        writeFile(DISSONANCE_METRO_CACHE_PATH, JSON.stringify(_metroCache));
      }, 1e3);
    }
  });
  ...
  var init_default = __esm({
    "src/core/i18n/default.json"() {
      default_default = {
        ...
        CODENAME: "Codename",
        COMMAND_DEBUG_DESC: "Send Dissonance debug info.",
        ...
        LOAD_FROM_CUSTOM_URL_DEC: "Load Dissonance from a custom endpoint.",
          ...
          /* @__PURE__ */ jsxs(TwinButtons, {
            children: [
              ...
              props.error instanceof Error ? /* @__PURE__ */ jsx(Button, {
                ...
                onPress: () => showSheet("DissonanceErrorDetailsActionSheet", ErrorDetailsActionSheet, {
                  error: props.error
                })
              }) : null
            ]
            ...
            /* @__PURE__ */ jsxs(import_react_native14.View, {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx(Text, {
                  ...
                  children: "A crash occurred while rendering a component. This could be caused by a plugin, Dissonance or Discord itself."
                }),
                /* @__PURE__ */ jsxs(Text, {
    ...
    "src/core/commands/debug.ts"() {
      ...
      debug_default = () => ({
        ...
        execute([ephemeral], ctx) {
          ...
          var content = [
            "**Dissonance Debug Info**",
            `> Dissonance: ${info.dissonance.version} (${info.dissonance.loader.name} ${info.dissonance.loader.version})`,
  ...
  // src/core/dissonance/plugins.ts
  ...
  var init_plugins = __esm({
    "src/core/dissonance/plugins.ts"() {
      ...
      init_constants();
      init_logger();
      plugins = wrapSync(createStorage(createMMKVBackend("DISSONANCE_PLUGINS")));
      pluginInstance = {};
      VdPluginManager = {
        plugins,
        pluginFetch(url2) {
          return _async_to_generator(function* () {
            if (url2.startsWith(VD_PROXY_PREFIX)) {
              url2 = url2.replace("https://dissonance-mod.github.io/plugins-proxy", DISSONANCE_PROXY_PREFIX).replace(VD_PROXY_PREFIX, DISSONANCE_PROXY_PREFIX);
            }
        ...
        evalPlugin(plugin) {
          return _async_to_generator(function* () {
            var dissonanceForPlugins = {
              ...
              logger: new LoggerClass(`Dissonance \xBB ${plugin.manifest.name}`)
            };
            var pluginString = `dissonance=>{return ${plugin.js}}
//# sourceURL=${plugin.id}`;
            var raw = (0, eval)(pluginString)(dissonanceForPlugins);
  ...
  function patchCommands() {
    var unpatch = after("getBuiltInCommands", commands, ([type], res) => {
      return [
        ...res,
        ...commands2.filter((c2) => (type instanceof Array ? type.includes(c2.type) : type === c2.type) && c2.__dissonance?.shouldHide?.() !== false)
      ];
    });
    [
  ...
  // src/core/dissonance/api.tsx
  var import_react3, import_react_native15, initDissonanceObject;
  var init_api = __esm({
    "src/core/dissonance/api.tsx"() {
      "use strict";
      init_asyncIteratorSymbol();
                ...
                if (props.includes("ActionSheetTitleHeader")) {
                  ...
                  return {
                    ...
                    ActionSheetContentContainer: ({ children }) => {
                      (0, import_react3.useEffect)(() => console.warn("Discord has removed 'ActionSheetContentContainer', please move into something else. This has been temporarily replaced with View"), []);
                      return /* @__PURE__ */ (0, import_react3.createElement)(import_react_native15.View, null, children);
                    }
                  };
                }
              }
  ...
  function wrapOnPress(onPress, navigation2, renderPromise, screenOptions, props) {
    return /* @__PURE__ */ _async_to_generator(function* () {
      ...
      navigation2.navigate("DISSONANCE_CUSTOM_PAGE", {
        ...screenOptions,
            ...
            children: [
              /* @__PURE__ */ jsx(TableRow, {
                ...
                trailing: /* @__PURE__ */ jsx(TableRow.TrailingText, {
                  text: debugInfo.dissonance.version
                })
              }),
              /* @__PURE__ */ jsx(TableRow, {
                label: "Discord",
              ...
              /* @__PURE__ */ jsx(TableRow, {
                ...
                onPress: () => navigation2.push("DISSONANCE_CUSTOM_PAGE", {
                  title: Strings.ABOUT,
            ...
            children: [
              ...
              /* @__PURE__ */ jsx(TableSwitchRow, {
                ...
                onValueChange: (to) => {
                  ...
                  openAlert("dissonance-reload-safe-mode", /* @__PURE__ */ jsx(AlertModal, {
                    title: "Reload now?",
        ...
        start() {
          ...
          after("default", useBadgesModule, ([user], r) => {
            ...
            (0, import_react6.useEffect)(() => {
              if (user) {
                fetch(`https://raw.githubusercontent.com/dissonance/badges/refs/heads/main/${user.userId}.json`).then((r2) => r2.json()).then((badges2) => setBadges(badgeCache[user.userId] = badges2));
              }
            }, [
              user
            ]);
  ...
  var init_plugins3 = __esm({
    "src/core/plugins/index.ts"() {
      ...
      init_promiseAllSettled();
      getCorePlugins = () => ({
        "dissonance.quickinstall": (init_quickinstall(), __toCommonJS(quickinstall_exports)),
        "dissonance.badges": (init_badges(), __toCommonJS(badges_exports))
      });
    }
  });
  ...
  var init_flux = __esm({
    "src/lib/api/flux/index.ts"() {
      ...
      init_promiseAllSettled();
      init_common();
      blockedSym = Symbol.for("dissonance.flux.blocked");
      modifiedSym = Symbol.for("dissonance.flux.modified");
  ...
  function createDissonancePluginApi(id) {
      ...
      if (!storedRepo) {
        for (var id in repo) {
          if (corePluginInstances.has(id)) {
            throw new Error(`Plugins can't have the same ID as any of Dissonance core plugin '${id}'`);
          }
        }
        updated = true;
    ...
    _startPlugin = _async_to_generator(function* (id, { throwIfDisabled = false, disableWhenThrown = true } = {}) {
      ...
      if (isExternalPlugin(manifest)) {
        try {
          ...
          var instantiator = globalEvalWithSourceUrl(`(dissonance,definePlugin)=>{${iife};return plugin?.default ?? plugin;}`, `dissonance-plugin/${id}-${manifest.version}`);
        } catch (error) {
        ...
        try {
          var api = createDissonancePluginApi(id);
              ...
              /* @__PURE__ */ jsx(import_react_native20.View, {
                ...
                children: SettingsComponent && /* @__PURE__ */ jsx(Button, {
                  ...
                  onPress: () => {
                    ...
                    navigation2.push("DISSONANCE_CUSTOM_PAGE", {
                      title: plugin.name,
  ...
  // src/core/ui/settings/pages/Plugins/models/dissonance.ts
  function unifyDissonancePlugin(dissonancePlugin) {
    return {
      ...
      toggle(start) {
        start ? VdPluginManager.startPlugin(dissonancePlugin.id) : VdPluginManager.stopPlugin(dissonancePlugin.id);
      },
  ...
  // src/core/ui/settings/pages/Plugins/models/dissonanceCore.ts
  function unifyDissonancePlugin2(manifest) {
    return {
      id: manifest.id,
  ...
  function Plugins() {
    ...
    return /* @__PURE__ */ jsx(PluginPage, {
      useItems: () => {
        ...
        var dissonancePlugins = Object.values(VdPluginManager.plugins).map(unifyDissonancePlugin);
        var dissonanceCorePlugins = [
          ...registeredPlugins.values()
        ].filter((p) => isPluginInstalled(p.id) && !isCorePlugin(p.id)).map(unifyDissonancePlugin2);
        return [
          ...dissonancePlugins,
          ...dissonanceCorePlugins
        ];
      },
      ListHeaderComponent: () => {
        var unproxiedPlugins = Object.values(VdPluginManager.plugins).filter((p) => !p.id.startsWith(VD_PROXY_PREFIX) && !p.id.startsWith(DISSONANCE_PROXY_PREFIX));
      ...
      installAction: {
        ...
        fetchFn: /* @__PURE__ */ function() {
          var _ref = _async_to_generator(function* (url2) {
            if (!url2.startsWith(VD_PROXY_PREFIX) && !url2.startsWith(DISSONANCE_PROXY_PREFIX) && !settings.developerSettings) {
              openAlert2("dissonance-plugin-unproxied-confirmation", /* @__PURE__ */ jsx(AlertModal3, {
                title: "Hold On!",
                ...
                actions: /* @__PURE__ */ jsxs(AlertActions2, {
                  children: [
                    /* @__PURE__ */ jsx(AlertActionButton3, {
                      ...
                      variant: "primary",
                      onPress: () => {
                        VdPluginManager.installPlugin(url2).then(() => showToast(Strings.TOASTS_INSTALLED_PLUGIN, findAssetId("Check"))).catch((e) => openAlert2("dissonance-plugin-install-failed", /* @__PURE__ */ jsx(AlertModal3, {
              ...
              children: [
                /* @__PURE__ */ jsxs(TableRadioGroup, {
                  ...
                  onChange: (type) => {
                    ...
                    getCurrentTheme()?.data && updateDissonanceColor(getCurrentTheme().data, {
                      update: true
                    });
                  },
                  children: [
  ...
  var init_fonts = __esm({
    "src/lib/addons/fonts/index.ts"() {
      ...
      init_fs();
      init_utils();
      fonts = wrapSync(createStorage(createMMKVBackend("DISSONANCE_FONTS")));
    }
  });
            ...
            isLoaderConfigSupported() && /* @__PURE__ */ jsx(Fragment, {
              children: /* @__PURE__ */ jsxs(TableRowGroup, {
                ...
                children: [
                  ...
                  isReactDevToolsPreloaded() && isDissonanceLoader() && /* @__PURE__ */ jsx(TableSwitchRow, {
  ...
  var init_lib = __esm({
    "src/lib/index.ts"() {
      ...
      init_lazy();
      managers = proxyLazy(() => {
        console.warn("dissonance.managers.* is deprecated, and moved the top level (dissonance.*). dissonance.managers will be eventually removed soon");
        return {
          get fonts() {
  ...
  var init_src = __esm({
    "src/index.ts"() {
      ...
      src_default = /* @__PURE__ */ _async_to_generator(function* () {
        ...
        window.dissonance = lib_exports;
        VdPluginManager.initPlugins().then((u) => unload.push(u)).catch(() => alert("Failed to initialize Dissonance plugins"));
        initPlugins();
        updateFonts();
  ...
  function initializeDissonance() {
    return _initializeDissonance.apply(this, arguments);
  }
  function _initializeDissonance() {
    _initializeDissonance = _async_to_generator(function* () {
      try {
